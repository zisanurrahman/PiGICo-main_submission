...
input_dir = "/Volumes/Expansion/New_transfer/SGI_genomes/Combined_SGI_PiBac/Antismash_gbk_on_filtered_Combined/gbk_files"
output_file = "/Users/zisan/Library/CloudStorage/Dropbox/SGI_Publication/Final_Analysis/Results/HvsD_Data/Adundance_Data/master_antismash_table.tsv"
...
if records:
    ...
    print(f"✅ antiSMASH mapping saved to {output_file}")
else:
